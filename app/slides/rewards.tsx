...
const styles = StyleSheet.create({
  ...
  labsTitleAligned: {
    ...
    lineHeight: moderateScale(21, 0.5),
    position: 'absolute',
  ...
  labsDescriptionText: {
    ...
    fontFamily: FONT_FAMILIES['Inter-Regular'],
    lineHeight: moderateScale(15, 0.5),
    includeFontPadding: isAndroid ? false : undefined,
    textAlignVertical: isAndroid ? 'center' : undefined,
  },
  ...
  streakLabel: {
    ...
    color: COLORS.black,
    fontFamily: FONT_FAMILIES['NotoSerif-Regular'],
    lineHeight: moderateScale(18, 0.5),
    backgroundColor: COLORS.white,
  ...
  milestoneDay: {
    ...
    fontFamily: FONT_FAMILIES['Inter-Regular'],
    lineHeight: moderateScale(10, 0.5),
    includeFontPadding: isAndroid ? false : undefined,
    textAlignVertical: isAndroid ? 'center' : undefined,
  },
  rewardsContainer: {
  ...
  streakText: {
    ...
    color: COLORS.warmPurple,
    fontFamily: FONT_FAMILIES['Inter-Regular'],
    lineHeight: moderateScale(12.5, 0.5),
    includeFontPadding: isAndroid ? false : undefined,
    textAlignVertical: isAndroid ? 'center' : undefined,
  },
});